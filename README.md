...
<title>مخيم محمد مطلق - وادي رم</title>  
<style>  
  * {margin:0; padding:0; box-sizing:border-box; font-family:'Tajawal', sans-serif;}  
  body {scroll-behavior:smooth; background:#f4f4f4; color:#2c3e50;}  /* Header */
header {
position:fixed; width:100%; top:0; background:rgba(44,62,80,0.95);
color:#fff; z-index:1000; padding:15px 20px;
...
nav {display:none; position:absolute; top:60px; right:0; width:200px; background:#333; text-align:center; border-radius:6px;}
nav a {display:block; padding:12px; color:#fff;}
...
background:url('https://lh3.googleusercontent.com/gps-cs-s/AC9h4noxptp2wBozJfEWiT9VzU_AgCTBfaPHj4Duv6Jwj66PGyAfEAK3jpFeMO04vSwI76ywoR2q11XDH2PCK8dw9LhAHKDqxTNKYYhqtbhhus6wLDGZcAjrKwE_KE6zE8tlmICjpqmx=s1416-w720-h1416-rw') center/cover no-repeat;
text-align:center; color:#fff; padding:0 20px;
}
#home h1 {font-size:3em; margin-bottom:20px; text-shadow:2px 2px 6px #000;}
#home p {font-size:1.2em; max-width:700px; text-shadow:1px 1px 4px #000; margin-bottom:30px;}
#home .btn {padding:15px 30px; background:#f39c12; color:#fff; border-radius:30px; font-size:1em; cursor:pointer;}
#home .btn:hover {background:#e67e22;}

/* Sections */
section {padding:120px 20px 50px; display:flex; flex-direction:column; align-items:center; width:100%;}
section h2 {font-size:2.5em; margin-bottom:40px; color:#2c3e50; text-align:center;}
#about, #booking {max-width:1000px; text-align:center;}
#about p, #booking p {margin-bottom:20px; line-height:1.6;}

/* Activities */
.activities {display:flex; flex-wrap:wrap; justify-content:center; gap:25px; width:100%; max-width:1200px;}
.activity-card {background:#fff; border-radius:15px; overflow:hidden; width:300px; box-shadow:0 8px 20px rgba(0,0,0,0.15); transition:0.3s;}
.activity-card:hover {transform:translateY(-10px); box-shadow:0 12px 25px rgba(0,0,0,0.2);}
.activity-card img {width:100%; height:200px; object-fit:cover;}
.activity-card .content {padding:20px; text-align:center;}
.activity-card h3 {margin-bottom:15px; color:#e67e22;}
.activity-card p {margin-bottom:15px; font-size:0.95em;}
.activity-card .btn {padding:10px 20px; background:#e67e22; color:#fff; border-radius:25px; transition:0.3s;}
.activity-card .btn:hover {background:#d35400;}
...
</section>  <!-- Activities -->  <section id="activities">  
  <h2>الأنشطة</h2>  
  <div class="activities">  <h1>البرامج السياحية في وادي رم</h1>

  <!-- نموذج كرت النشاط -->    <div class="activity-card">  
...
Begin your adventure from Rum Village as we set off on a scenic jeep ride across the desert. Along the way, we’ll visit iconic sites such as Lawrence’s Spring, Khazali Canyon, and the Small Arch, immersing you in the beauty and history of Wadi Rum.
...
Meet your guide in Wadi Rum and start your adventure in a 4x4 jeep.
...
</section>  <!-- Booking -->  <section id="booking">  
  <h2>Reservations</h2>  
...
</section>  <!-- Location -->  <section id="location">  
  <h2>الموقع</h2>  
<iframe  
...
</footer>  <!-- Modal -->  <div class="modal" id="activityModal">  
